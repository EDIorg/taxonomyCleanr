---
title: "A common use case for the taxonomyCleanr"
...
data <- read.table(system.file('example_data.txt', package = 'taxonomyCleanr'), header = T, sep = '\t', stringsAsFactors = F)
```
...
# Create the taxa map
my_path <- '/Users/csmith/Documents/data'
