...
- Make taxonomicCoverage.xml (coming soon)
...
data <- read.table(paste0(path.package('taxonomyCleanr'), '/test_data.txt'), header = T, sep = '\t', stringsAsFactors = F)
```
...
# View documentation for resolve_comm_taxa
?resolve_comm_taxa
